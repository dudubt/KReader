...
public final class ReaderActivity extends BaseReaderActivity implements ZLApplicationWindow {
...
//        );
    ...
    public static void openBookActivity(Context context, Book book, Bookmark bookmark) {
        final Intent intent = new Intent(context, ReaderActivity.class);
    ...
    protected void onResume() {
        ...
        Config.Instance().runOnConnect(new Runnable() {
            public void run() {
                ...
                getCollection().bindToService(ReaderActivity.this, new Runnable() { // 字体类型等设置改变时更新界面 clearTextCaches(); getViewWidget().repaint();
                    public void run() {
...
//    }
    ...
    public void showSelectionPanel() {
        final ZLReaderView view = myKooReaderApp.getTextView();
